...
<div class="dash-board">
	...
	<fieldset >
	<legend >Phylo-Metagenomics Reports (v<?php echo(METAREP_VERSION)?>)</legend>
	<div class="dash-board-abstract">	
			<p>JCVI supports the Gordon and Betty Moore Foundation's (GBMF) <strong>Marine Microbiology Initiative (MMI)</strong> 
		with Phylo-Metagenomics Reports (<strong>Phylo-METAREP</strong> ), a dedicated online resource to make large volumes of annotated marine transcriptomes amenable for exploratory data analysis.<BR></BR>
		<p>Phylo-METAREP</strong> provides a suite of <strong>high-performance</strong> web based tools 
		to <strong>view, query, browse</strong> and <strong>compare</strong> annotated transcriptomes in realtime.
		</p>
		It enables scientists to <strong>slice and dice</strong> data and <strong>compare multiple datasets/conditions</strong> at various functional and taxonomic levels applying statistical tests as well as hierarchical clustering, multidimensional scaling and heatmaps. Additional information:</p>
		<BR><p> 
...
<div class="dash-board-camera-panel">
<fieldset><legend>In Partnership With</legend> <?php  
echo $html->link($html->image("http://www.calit2.net/images/articles/2010/CAMERA_color.jpg",array("title" => 'Solr','class'=>'hmp-img-alignment')), 'http://www.calit2.net',array('escape' => false,'target' => '_blank'));
?></fieldset>
</div>
