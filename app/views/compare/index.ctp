...
<fieldset class="comparator-option-panel">
						...
						array('options' => 	
							array(	'Count Matrices' => array( 
									...
									'Statistical Tests (2 populations)' => array( 
												...
												EDGE_R =>'edgeR - Exact Negative Binomial Test',),								
									'Plots' => array( 
	...
	echo $ajax->submit('Update', array('url'=> array('controller'=>'compare', 'action'=>'ajaxTabPanel'),'update' => 'tab-panel', 'indicator' => 'spinner','loading' => 'Element.show(\'spinner\');Element.hide(\'comparator-download\')', 'complete' => 'Element.hide(\'spinner\'); Element.hide(\'tab-panel\');Effect.Appear(\'tab-panel\',{ duration: 0.5})'));
