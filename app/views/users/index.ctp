<!----------------------------------------------------------
  ...
  The User Index Page lists all registered METAREP users. This
  feature is only available to the METAREP admin user.
...
<ul id="breadcrumb">
    ...
    <li><?php echo $html->link('Manage Users', "/users/index");?></li>
</ul>
